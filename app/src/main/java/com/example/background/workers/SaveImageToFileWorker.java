...
public class SaveImageToFileWorker extends Worker {
    ...
    public WorkerResult doWork() {
        ...
        try {
            String resourceUri = getInputData().getString(Constants.KEY_IMAGE_URI,null);// TODO get the input Uri from the Data object
            ...
            setOutputData(new androidx.work.Data.Builder().putString(Constants.KEY_IMAGE_URI,imageUrl).build());
